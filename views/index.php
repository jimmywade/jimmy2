        ...
        <div class="row">
            <div class="col-xs-12 col-sm-3" >
                ...
                <div id="imageUpdate" style="display:none;">
                    ...
                    <div style="text-align:center; margin:0 auto;" class="btn btn-primary" ngf-select="upload($file)">
...
<section id="proyectosCreate" style="display:none;">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="form-group">
                    <label class="control-label col-xs-4" for="problemaProyecto">Identificaci&oacute;n del problema o necesidad:</label>
                    <div class="col-xs-8">
